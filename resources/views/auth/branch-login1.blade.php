        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('branch.login.submit') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                            <label for="id" class="col-md-4 control-label">Branch ID</label>
                        ...
                        <div class="form-group{{ $errors->has('rid') ? ' has-error' : '' }}">
                            <label for="rid" class="col-md-4 control-label">Restaurant ID</label>
